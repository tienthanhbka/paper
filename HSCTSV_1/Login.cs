...
namespace HSCTSV_1
{
    public partial class Login : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        public Login()
        {
            InitializeComponent();
            checkUpdate();
            txtUserName.Text = Properties.Settings.Default.saveFile;
            txtPassword.Text = "hungpm102@";
        }
        ...
        {      
            ...
            {           
                ...
                Login.userLogin = await new ConnectDB.UserDB().userLogin(objReq);
            ...
            if (Login.userLogin.RespCode == 0)
            {
                ...
                Properties.Settings.Default.saveFile = txtUserName.Text;
